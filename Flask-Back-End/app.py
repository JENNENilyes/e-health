...
training_data = open(r"C:\Users\usre\Desktop\rea\e-health-app\Flask-Back-End\data\data.txt").read().splitlines()
training_data_disease= open(r"C:\Users\usre\Desktop\rea\e-health-app\Flask-Back-End\data\data1.txt").read().splitlines()
training_data_stroke = open(r"C:\Users\usre\Desktop\rea\e-health-app\Flask-Back-End\data\data2.txt").read().splitlines()
